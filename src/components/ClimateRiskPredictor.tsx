    ...
    if ('speechSynthesis' in window) {
      ...
      const populateVoices = () => {
        ...
        if (!hasUrdu && !hasHindi && !hasEnglish) {
          ...
          setVoiceWarning(
            '⚠️ No Urdu or Hindi voice found.  Speech may not work or may use an unexpected accent.'
          );
        } else if (!hasUrdu) {
          setVoiceWarning(
            '⚠️ No Urdu voice found. Speech may not work or may use an unexpected accent.'
          );
        } else {
